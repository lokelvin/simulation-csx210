 ...
 */
class JacksonNet (p: MatrixD, r: VectorD, mu: VectorD, private var k: VectorI = null)
...
//   private val lambda = r                          // no routing
     ...
     if (k == null) k = new VectorI (m); k.set (1)   // default to M/M/1 queues

     /** Utilization factor for each node
      */
     private val rho = lambda / (mu * k.toDouble)
     ...
     //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     /** Calculate the expected number in the queue at the jth node.
      *  @param j  the jth node
      */
     ...
     //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     /** Calculate the expected number in the queue at the jth node for an M/M/1 queue.
      *  @param j  the jth node
      */
